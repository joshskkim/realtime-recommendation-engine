...
latency_p50 = np.random.Generator(170, 0.052, 60)
latency_p95 = np.random.Generator(165, 10, 60)
latency_p99 = np.random.Generator(420, 20, 60)
throughput = np.random.Generator(12500, 500, 60)
...
# Cache hit rate
cache_hit_rate = np.random.Generator(87, 2, 60)
...
# Error rate
error_rate = np.random.Generator(0.05, 0.02, 60)
